...
// California students: Assignment 1
const calStudents = utme2024Students.filter((each)=>{
  return each.state == "California"
  
})
console.log(calStudents);
...
// the firstName and score for each student
const firstNameScore = utme2024Students.map((each) =>{
  return `${each.firstName} ${each.score}`
})
console.log(firstNameScore);

// Average score of all students

// Extract scores from the students array
const scores = utme2024Students.map(student =>student.score);
